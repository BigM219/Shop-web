      ...
      <div className=" space-x-3">
        {userAccessToken && userInfo?._id ? (
          <>
            <div className="items-center space-x-2 p-3 group hover:cursor-pointer flex">
              ...
              <div className="whitespace-nowrap leading-4">
                <p className="text-[12px]">
                  Xin Chào,{userInfo.name.substring(0, 9)}
                </p>
              </div>
            </div>
            ...
            <div className="block space-y-2">
              <p>
                <Link
                  to="/checkout"
                  className=" hover:bg-yellow-700/50 p-2 rounded-md ease-out duration-100"
                >
          ...
          <div className="w-full p-3">
            <Link
              to="/login"
              className="flex items-center w-full hover:bg-yellow-700/50 p-2 rounded-md ease-out duration-100"
            >
